        ...
        <div class="col-9">
              ...
              <div class="card-cont">
                ...
                <form>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" readonly class="form-control-plaintext" value="{{$rekening->namaBank}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">No. Rekening</label>
                    <div class="col-sm-10">
                      <input type="text" readonly class="form-control-plaintext" value="{{$rekening->noRekening}}">
                    </div>
                  </div>
                </form>
              </div>
          ...
          <div class="lanjut">
            <div class="card">
              <div class="card-cont">
                <h1>Rekening Saya</h1>
                <h5>Rekening hanya bisa diisi satu kali!<h5>
                <div class="dropdown-divider"></div>
                <form>
                  <div class="form-group row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Nama Bank</label>
