...
<div class="sidenav">
        ...
        <a href="#" class="text-center" class="active" style="color: #212121;"><i class="bi bi-cash-stack" ></i>Penghasilan</a>
                ...
                <div class="col-sm-10">
                    <div class="card border-0 shadow">
                        <div class="card-body p-4">
                            <div class="table-responsive"><h1>Penghasilan Saya</h1>
                            <div class="dropdown-divider"></div>
                                <table class="table m-0">
                                    <thead>
                                        <tr>
                                          Buku Terjual &emsp;&emsp;&emsp;&emsp; <b>302</b><br>
                                          Total Penghasilan &emsp; <b>Rp5.000.000,00</b>
                                        </tr><br><br>
                                        <button type="submit" class="btn btn-prove">Ajukan Penarikan Dana</button>
                                    </thead>
                                        <tr>
