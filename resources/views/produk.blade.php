                ...
                <div class="col-sm-12">
                    <div class="card border-0 shadow">
                        <div class="card-body p-4">
                            <div class="table-responsive"><h1>Buku Bekas Jualan Saya</h1>
                                <table class="table m-0"><div class="container-header">
            <hr class="hr1">
            <div class="header-bottom">
                <button class="btn btn-bookas">Semua</button>
                <button class="btn btn-secondary"><i class="bi bi-filter"></i>Filter</button>
                <button class="btn btn-secondary">Paling Laku</button>
            </div>
        </div>
        <div class="row">
          <div class="col-2">
            <div class="card" >
              ...
              <p class="book-price" style="color: #EA6941;">Rp. 112.000</p>
              </div>
              <button type="submit" class="btn btn-edit">Edit</button>
              <button type="submit" class="btn btn-bookas">Hapus</p></button>
            </div>
          </div>
          <div class="col-2">
            <div class="card" >
          ...
          <div class="col-12">
          <button class="btn-right" style="color: #EA6941;"><i class="bi bi-plus-circle-fill"></i></button>
          </div>
        </div>
      </div>
    </section>
